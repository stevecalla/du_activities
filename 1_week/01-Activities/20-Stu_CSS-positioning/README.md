...
<input type='checkbox'> It's done when `box 2` is positioned in the middle of `square 1` using relative positioning.

<input type='checkbox'> It's done when `box 2` is positioned outside of the upper-right corner of `square 2` using absolute positioning.
