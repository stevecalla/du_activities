...
<input type='checkbox'> It's done when each box has a defined `padding` property.

<input type='checkbox'> It's done when each box has a defined `margin` property.

<input type='checkbox'> It's done when each box has a defined `border` property.
