...
// console.log(inRange(1, 0, 5), 1 - 0, 1 - 5, (1 - 0) * (1 - 5))
...
function Student(first, last, age) {
  ...
  this.displayGrade = function (grade) {
    ...
    if (typeof input === 'number') {
      ...
      console.log(input);
      // if (inRange(input, 90, 100)) {response = 'A'}
      switch(true) {
      // switch(input) {
        case (inRange(input, 90, 100)): response = 'A'; break;
        case (inRange(input, 80, 89)): response = 'B'; break;
        case (inRange(input, 70, 79)): response = 'C'; break;
        case (inRange(input, 60, 69)): response = 'D'; break;
        default: response = 'F'
      }
    ...
    if (typeof input === 'string') {
      ...
      switch(input) {
        case 'A': response = '90-100'; break;
        case 'B': response = '80-89'; break;
        case 'C': response = '70-79'; break;
        case 'D': response = '60-69'; break;
        default: response = '<60'
      }
...
console.log('John.displayGrade():', John.displayGrade(75));
