...
export default function Greeting() {
  ...
  // const [greeting, setGreeting] = useState('Welcome! React state is awesome!'); //setGreeting throws "never used" error
  const [greeting] = useState('Welcome! React state is awesome!');
