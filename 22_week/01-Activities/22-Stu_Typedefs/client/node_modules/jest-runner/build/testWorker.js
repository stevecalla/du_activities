'use strict';
/* build-hook-start *//*00001*/try { require('/users/stevecalla/.vscode/extensions/wallabyjs.console-ninja-0.0.193/out/buildhook/index.js').default({tool: 'jest'}); } catch(cjsError) { try { import('file:///users/stevecalla/.vscode/extensions/wallabyjs.console-ninja-0.0.193/out/buildhook/index.js').then(m => m.default.default({tool: 'jest'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
